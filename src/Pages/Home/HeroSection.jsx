        ...
        <section id="heroSection" className="hero--section" ref={heroRef}>
            ...
            <div className="hero--section--content--box">
                ...
                <div className="hero--actions">
                    <button className="hero--btn hero--btn--primary">Contact Me</button>
                    <button className="hero--btn hero--btn--ghost">Download CV (PDF)</button>
                    <div className="hero--social">
                        <a className="hero--social__link" href="#" aria-label="LinkedIn">
                        ...
                        <a className="hero--social__link" href="#" aria-label="GitHub">
                            <svg viewBox="0 0 24 24" aria-hidden="true">
                                <path
